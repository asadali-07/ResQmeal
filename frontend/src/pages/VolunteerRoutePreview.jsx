...
const VolunteerRoutePreview = () => {
    ...
    const { volunteer, loading: volunteerLoading, error: volunteerError } = useSelector(
    ...
    const requestLiveLocation = () => {
        if (!navigator.geolocation) {
            setLocationNote(
                "Live location is unavailable in this browser. Using your volunteer profile coordinates."
            );
            return;
        }
        ...
        navigator.geolocation.getCurrentPosition(
            (position) => {
                ...
                setLocationNote("Using your live device location for this pickup route.");
            },
            () => {
                setLocationNote(
                    "Live location permission was denied. Using your volunteer profile coordinates."
                );
            },
                    ...
                    <div style={{ height: 560 }}>
                        ...
                        >
                            ...
                            {!routeFeature && fallbackRoute && (
                                <Source id="volunteer-route-fallback" type="geojson" data={fallbackRoute}>
