...
import { createRestaurant, getUserRestaurant, updateRestaurant } from "../store/restaurantSlice";
            ...
            <div className="flex flex-wrap items-center justify-between gap-3">
                <div>
                    <h2 className="font-display text-3xl">
                        {restaurant ? "Restaurant command center" : "Create restaurant profile"}
                    </h2>
                    ...
                    <div className="glass-panel rounded-3xl border border-white/70 p-6">
                        ...
                        <form onSubmit={handleSubmit(onSubmit)} className="mt-6 space-y-4">
                            ...
                            <div className="grid gap-4 md:grid-cols-2">
                                <div>
                                    <label className="text-sm font-semibold">Food license number</label>
                                    <input
                                        type="text"
                                ...
                                <div>
                                    <label className="text-sm font-semibold">Restaurant picture</label>
                                    <input
                                        type="file"
                                        accept="image/*"
                    ...
                    <div className="glass-panel rounded-3xl border border-white/70 p-6">
                        ...
                        <div className="mt-4 grid gap-3 text-sm text-[var(--muted)]">
                            ...
                            <div className="flex items-center justify-between rounded-2xl border border-white/80 bg-white/80 px-4 py-3">
                                ...
                                <span className="font-semibold text-[var(--ink)]">Manage in food tab</span>
                            </div>
                        </div>
                    </div>
                </div>
