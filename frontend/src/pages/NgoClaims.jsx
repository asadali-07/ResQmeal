...
const NgoClaims = () => {
        ...
        return (
            ...
            >
                ...
                <div className="mt-4 grid gap-2">
                    ...
                    <div className="flex justify-between">
                        <span className="text-(--muted)">Claimed at</span>
                        <span className="font-semibold text-(--ink)">
    ...
    if (!userInfo) {
        return (
            <div className="glass-panel rounded-3xl border border-white/70 p-8 text-center">
                <p className="text-sm text-(--muted)">Please login to access NGO claims.</p>
                <NavLink
                    to="/login"
    ...
    if (userInfo.role !== "ngo") {
        return (
            <div className="glass-panel rounded-3xl border border-white/70 p-8 text-center">
                <p className="text-sm text-(--muted)">This space is reserved for NGO partners.</p>
                <NavLink
                    to="/"
        ...
        <div className="space-y-8">
            ...
            <div className="grid gap-4 md:grid-cols-3">
                <div className="glass-panel rounded-3xl border border-white/70 p-5">
                    ...
                    <p className="mt-3 font-display text-3xl text-(--ink)">{claimedFoods.length}</p>
                </div>
                <div className="glass-panel rounded-3xl border border-white/70 p-5">
                    <p className="text-xs font-semibold uppercase tracking-[0.2em] text-(--muted)">
                        Active
            ...
            <div className="glass-panel rounded-3xl border border-white/70 p-6">
                <div className="flex items-center justify-between gap-3">
                    ...
                    <span className="text-sm text-(--muted)">{completedClaims.length} closed</span>
                </div>
