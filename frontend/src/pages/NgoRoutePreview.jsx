...
const NgoRoutePreview = () => {
  ...
  const ngoCoords =
    ngo?.location?.coordinates?.length === 2 ? ngo.location.coordinates : null;
      ...
      <div className="flex flex-wrap items-center justify-between gap-3">
        <div>
          ...
          <p className="text-sm text-(--muted)">
            Route planning from your NGO base or live device location to the
        ...
        <div className="glass-panel overflow-hidden rounded-3xl border border-white/70">
          <div className="border-b border-white/70 px-6 py-4">
            <h3 className="font-display text-lg">
              {routeFood?.name || "Route map"}
            </h3>
            <p className="text-sm text-(--muted)">
              Orange line shows the driving route when available. Blue line is
              the direct fallback preview.
            </p>
          </div>
