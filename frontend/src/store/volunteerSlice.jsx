...
export const createVolunteer = createAsyncThunk(
    ...
    async (payload, { rejectWithValue }) => {
        try {
            ...
            return rejectWithValue(getErrorMessage(error, "Failed to create volunteer"));
        }
    }
);
...
export const getUserVolunteer = createAsyncThunk(
    ...
    async (_, { rejectWithValue }) => {
        try {
            ...
            return rejectWithValue(getErrorMessage(error, "Failed to fetch volunteer"));
        }
    }
);
...
export const updateVolunteer = createAsyncThunk(
    ...
    async (payload, { rejectWithValue }) => {
        try {
            ...
            return rejectWithValue(getErrorMessage(error, "Failed to update volunteer"));
        }
    }
);
...
export const getAllVolunteers = createAsyncThunk(
    ...
    async (_, { rejectWithValue }) => {
        try {
            ...
            return rejectWithValue(getErrorMessage(error, "Failed to fetch volunteers"));
        }
    }
);
...
export const getAvailableVolunteers = createAsyncThunk(
    ...
    async (_, { rejectWithValue }) => {
        try {
            ...
            return rejectWithValue(getErrorMessage(error, "Failed to fetch available volunteers"));
        }
    }
);
...
export const deleteVolunteer = createAsyncThunk(
    ...
    async (volunteerId, { rejectWithValue }) => {
        try {
            ...
            return rejectWithValue(getErrorMessage(error, "Failed to delete volunteer"));
        }
    }
);
