...
export const createRestaurant = createAsyncThunk(
    ...
    async (payload, { rejectWithValue }) => {
        try {
            ...
            return rejectWithValue(getErrorMessage(error, "Failed to create restaurant"));
        }
    }
);
...
export const getUserRestaurant = createAsyncThunk(
    ...
    async (_, { rejectWithValue }) => {
        try {
            ...
            return rejectWithValue(getErrorMessage(error, "Failed to fetch restaurant"));
        }
    }
);
...
export const getRestaurantById = createAsyncThunk(
    ...
    async (restaurantId, { rejectWithValue }) => {
        try {
            ...
            return rejectWithValue(getErrorMessage(error, "Failed to fetch restaurant information"));
        }
    }
);
...
export const updateRestaurant = createAsyncThunk(
    ...
    async (payload, { rejectWithValue }) => {
        try {
            ...
            return rejectWithValue(getErrorMessage(error, "Failed to update restaurant"));
        }
    }
);
...
export const getAllRestaurants = createAsyncThunk(
    ...
    async (_, { rejectWithValue }) => {
        try {
            ...
            return rejectWithValue(getErrorMessage(error, "Failed to fetch restaurants"));
        }
    }
);
...
export const deleteRestaurant = createAsyncThunk(
    ...
    async (restaurantId, { rejectWithValue }) => {
        try {
            ...
            return rejectWithValue(getErrorMessage(error, "Failed to delete restaurant"));
        }
    }
);
    ...
    extraReducers: (builder) => {
        builder
            ...
            .addCase(getRestaurantById.rejected, (state, action) => {
                state.loading = false;
                state.error = action.payload || "Failed to fetch restaurant information";
            })
...
export const { clearRestaurantError, clearSelectedRestaurant } = restaurantSlice.actions;
