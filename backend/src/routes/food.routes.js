...
const {  createFood, updateFood, getAvailableFood, getFoodById,deleteFood, getAllFoodListing } = require('../controllers/food.controller');
...
foodRouter.post('/',createAuthMiddleware(["restaurant"]),upload.single("foodImage"),createFood)
    ...
    .get('/listings',createAuthMiddleware(["restaurant"]),getAllFoodListing)
