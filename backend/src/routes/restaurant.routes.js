...
const {createRestaurant, getAllRestaurants, updateRestaurant, getUserRestaurant, deleteRestaurant, getRestaurantById} = require('../controllers/restaurant.controller');
